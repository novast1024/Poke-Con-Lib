...
def N(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, rightstick = _N_STICK_INPUT)

def NNE(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, rightstick = _NNE_STICK_INPUT)

def NE(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, rightstick = _NE_STICK_INPUT)

def ENE(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, rightstick = _ENE_STICK_INPUT)

def E(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, rightstick = _E_STICK_INPUT)

def ESE(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, rightstick = _ESE_STICK_INPUT)

def SE(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, rightstick = _SE_STICK_INPUT)

def SSE(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, rightstick = _SSE_STICK_INPUT)

def S(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, rightstick = _S_STICK_INPUT)

def SSW(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, rightstick = _SSW_STICK_INPUT)

def SW(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, rightstick = _SW_STICK_INPUT)

def WSW(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, rightstick = _WSW_STICK_INPUT)

def W(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, rightstick = _W_STICK_INPUT)

def WNW(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, rightstick = _WNW_STICK_INPUT)

def NW(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, rightstick = _NW_STICK_INPUT)

def NNW(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, rightstick = _NNW_STICK_INPUT)
