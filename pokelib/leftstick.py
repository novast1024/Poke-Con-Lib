...
def NNE(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, leftstick = StickInput(cos(pi * 0.375), -sin(pi * 0.375)))

def NE(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, leftstick = StickInput(cos(pi * 0.25), -sin(pi * 0.25)))

def ENE(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, leftstick = StickInput(cos(pi * 0.125), -sin(pi * 0.125)))

def E(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, leftstick = _RIGHT_STICK_INPUT)

def ESE(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, leftstick = StickInput(cos(pi * 1.875), -sin(pi * 1.875)))

def SE(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, leftstick = StickInput(cos(pi * 1.75), -sin(pi * 1.75)))

def SSE(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, leftstick = StickInput(cos(pi * 1.625), -sin(pi * 1.625)))

def S(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, leftstick = _DOWN_STICK_INPUT)

def SSW(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, leftstick = StickInput(cos(pi * 1.375), -sin(pi * 1.375)))

def SW(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, leftstick = StickInput(cos(pi * 1.25), -sin(pi * 1.25)))

def WSW(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, leftstick = StickInput(cos(pi * 1.125), -sin(pi * 1.125)))

def W(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, leftstick = _LEFT_STICK_INPUT)

def WNW(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, leftstick = StickInput(cos(pi * 0.875), -sin(pi * 0.875)))

def NW(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, leftstick = StickInput(cos(pi * 0.75), -sin(pi * 0.75)))

def NNW(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or settings.input_seconds, leftstick = StickInput(cos(pi * 0.625), -sin(pi * 0.625)))
