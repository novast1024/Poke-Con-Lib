...
def Y(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or default.input_seconds, button = _Y_BUTTON_INPUT)

def B(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or default.input_seconds, button = _B_BUTTON_INPUT)

def A(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or default.input_seconds, button = _A_BUTTON_INPUT)

def X(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or default.input_seconds, button = _X_BUTTON_INPUT)

def L(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or default.input_seconds, button = _L_BUTTON_INPUT)

def R(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or default.input_seconds, button = _R_BUTTON_INPUT)

def ZL(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or default.input_seconds, button = _ZL_BUTTON_INPUT)

def ZR(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or default.input_seconds, button = _ZR_BUTTON_INPUT)

def Minus(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or default.input_seconds, button = _MINUS_BUTTON_INPUT)

def Plus(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or default.input_seconds, button = _PLUS_BUTTON_INPUT)

def LS(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or default.input_seconds, button = _LS_BUTTON_INPUT)

def RS(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or default.input_seconds, button = _RS_BUTTON_INPUT)

def Home(seconds: float = 0.0) -> GamepadInput:
    return GamepadInput(seconds or default.input_seconds, button = _HOME_BUTTON_INPUT)

def Capture(seconds: float = 0.0) -> GamepadInput: 
    return GamepadInput(seconds or default.input_seconds, button = _CAPTURE_BUTTON_INPUT)
