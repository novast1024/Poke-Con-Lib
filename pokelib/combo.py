...
class Combo:
    def __init__(self, minimum_interval: float = -1.0) -> None:
        ...
        self.minimum_interval = minimum_interval if minimum_interval >= 0.0 else default.minimum_interval
    ...
    def send(self):
        ...
        for i in self.pool:
            ...
            default.python_command.keys.ser.ser.write((i.to_pokecon_str(ls, rs) + '\r\n').encode('utf-8'))
            prev = i
            time.sleep(i.seconds)
        default.python_command.checkIfAlive()
